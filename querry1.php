    ...
    <div class="datatablecontainer container mt-4">
        <table id="myTable" class="display table table-bordered">
            ...
            <tbody>
                ...
                include 'koneksi.php';
                $no = 1;
                $data = mysqli_query($koneksi, "SELECT P.Name AS Nama_Mahasiswa, L.CourseID AS ID_Matakuliah, L.Status AS Status
                FROM L1 L
                JOIN PERSON P ON L.ID = P.ID
                WHERE L.ID IN ('0000041', '0000042')
                UNION ALL
                SELECT P.Name AS Nama_Mahasiswa, L.CourseID AS ID_Matakuliah, L.Status AS Status
                FROM L2 L
                JOIN PERSON P ON L.ID = P.ID
                WHERE L.ID IN ('0000041', '0000042')
                UNION ALL
